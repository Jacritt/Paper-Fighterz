...
public class CharacterSelect : MonoBehaviour
{
    ...
    public Text p1_CharacterNameText;
    public Image p2_CharacterImage;
    public Text p2_CharacterNameText;
    public int maxSlots;
    ...
    public void HandleInput(){
        ...
        if(Input.GetKeyDown(KeyCode.UpArrow) && !isP1Selected){
            if (p2_Current_Slot-5 < 0){return;}
            p2_Current_Slot = p2_Current_Slot-5;
        }
        if(Input.GetKeyDown(KeyCode.DownArrow) && !isP1Selected){
